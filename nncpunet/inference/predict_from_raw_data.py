...
from nncpunet.inference.data_iterators import PreprocessAdapterFromNpy, preprocessing_iterator_fromfiles, \
    preprocessing_iterator_fromnpy
from nncpunet.inference.export_prediction import export_prediction_from_logits, \
    convert_predicted_logits_to_segmentation_with_correct_shape
from nncpunet.inference.sliding_window_prediction import compute_gaussian, \
    compute_steps_for_sliding_window
from nncpunet.utilities.file_path_utilities import get_output_folder, check_workers_alive_and_busy
from nncpunet.utilities.find_objects import recursive_find_trainer_class_by_name
from nncpunet.utilities.helpers import empty_cache, dummy_context
from nncpunet.utilities.json_export import recursive_fix_for_json_export
...
from nncpunet.utilities.utils import create_lists_from_splitted_dataset_folder
...
def predict_entry_point_modelfolder():
    ...
    parser.add_argument('-device', type=str, default='cuda', required=False,
                        help="Use this to set the device the inference should run with. Available options are 'cuda' "
                             ...
                             "Use CUDA_VISIBLE_DEVICES=X nnCPUnet_predict [...] instead!")
...
def predict_entry_point():
    ...
    parser.add_argument('-num_parts', type=int, required=False, default=1,
                        help='Number of separate nnCPUnet_predict call that you will be making. Default: 1 (= this one '
                             'call predicts everything)')
    parser.add_argument('-part_id', type=int, required=False, default=0,
                        help='If multiple nnCPUnet_predict exist, which one is this? IDs start with 0 can end with '
                             'num_parts - 1. So when you submit 5 nnCPUnet_predict calls you need to set -num_parts '
    ...
    assert args.part_id < args.num_parts, 'Do you even read the documentation? See nnCPUnet_predict -h.'
...
if __name__ == '__main__':
    ...
    from nncpunet.paths import nnUNet_results
    ...
    # from nncpunet.imageio.simpleitk_reader_writer import SimpleITKIO
    #
