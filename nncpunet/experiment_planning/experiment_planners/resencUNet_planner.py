...
nncpunet.experiment_planning.experiment_planners.residual_unets.residual_encoder_unet_planners,
...
from nncpunet.experiment_planning.experiment_planners.residual_unets.residual_encoder_unet_planners import (
    ResEncUNetPlanner,
)
...
warnings.warn(
    "nncpunet.experiment_planning.experiment_planners.resencUNet_planner is deprecated. Import "
    "ResEncUNetPlanner from nncpunet.experiment_planning.experiment_planners.residual_unets."
