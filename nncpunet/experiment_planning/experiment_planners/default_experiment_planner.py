...
from nncpunet.configuration import ANISO_THRESHOLD
from nncpunet.experiment_planning.experiment_planners.network_topology import get_pool_and_conv_props
from nncpunet.imageio.reader_writer_registry import determine_reader_writer_from_dataset_json
from nncpunet.paths import nnUNet_raw, nnUNet_preprocessed
from nncpunet.preprocessing.normalization.map_channel_name_to_normalization import get_normalization_scheme
from nncpunet.preprocessing.resampling.default_resampling import resample_data_or_seg_to_shape, compute_new_shape
...
from nncpunet.utilities.utils import get_filenames_of_train_images_and_targets
...
class ExperimentPlanner(object):
    def __init__(self, dataset_name_or_id: Union[str, int],
        ...
        if not isfile(join(preprocessed_folder, 'dataset_fingerprint.json')):
            raise RuntimeError('Fingerprint missing for this dataset. Please run nnCPUnet_extract_fingerprint')
