...
from nncpunet.experiment_planning.dataset_fingerprint.fingerprint_extractor import DatasetFingerprintExtractor
from nncpunet.experiment_planning.experiment_planners.default_experiment_planner import ExperimentPlanner
from nncpunet.experiment_planning.verify_dataset_integrity import verify_dataset_integrity
from nncpunet.paths import nnUNet_raw, nnUNet_preprocessed
from nncpunet.utilities.dataset_name_id_conversion import convert_id_to_dataset_name
from nncpunet.utilities.find_class_by_name import recursive_find_python_class
from nncpunet.utilities.plans_handling.plans_handler import PlansManager
...
def extract_fingerprints(dataset_ids: List[int], fingerprint_extractor_class_name: str = 'DatasetFingerprintExtractor',
                         ...
                         show_progress_bar: bool = True):
    """
    clean = False will not actually run this. This is just a switch for use with nnCPUnet_plan_and_preprocess where
    we don't want to rerun fingerprint extraction every time.
    """
    fingerprint_extractor_class = recursive_find_python_class(join(nncpunet.__path__[0], "experiment_planning"),
