...
from nncpunet.utilities.load_weights_utils import *
warmup_stages = Literal["warmup_all", "warmup_decoder", "train_all", "train_decoder"]
from nncpunet.training.nnUNetTrainer.pretraining.pretrainedTrainer import PretrainedTrainer
...
class DynamicPretrainedTrainer(PretrainedTrainer):
    ...
    def load_pretrained_weights_dynamic(
        ...
        if stem_in_encoder:
            ...
            from nncpunet.utilities.load_weights_utils import adapt_conv_kernel_size
