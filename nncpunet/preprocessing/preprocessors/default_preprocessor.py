...
import nncpunet
from nncpunet.paths import nnUNet_preprocessed, nnUNet_raw
from nncpunet.preprocessing.cropping.cropping import crop_to_nonzero
from nncpunet.preprocessing.resampling.default_resampling import compute_new_shape
from nncpunet.training.dataloading.nnunet_dataset import nnUNetDatasetBlosc2, comp_blosc2_params
...
class DefaultPreprocessor(object):
    ...
    def _normalize(self, data: np.ndarray, seg: np.ndarray, configuration_manager: ConfigurationManager,
        ...
        for c in range(data.shape[0]):
            ...
            normalizer_class = recursive_find_python_class(join(nncpunet.__path__[0], "preprocessing", "normalization"),
                                                           scheme,
                                                           'nncpunet.preprocessing.normalization')
...
def example_test_case_preprocessing():
    ...
    input_images = ['/home/isensee/drives/e132-rohdaten/nncpunet/Dataset219_AMOS2022_postChallenge_task2/imagesTr/amos_0600_0000.nii.gz', ]  # if you only have one channel, you still need a list: ['case000_0000.nii.gz']
