...
```commandline
bash nncpunet/tests/integration_tests/prepare_integration_tests.sh
```

Now you can run the integration test for each of the datasets:
```commandline
bash nncpunet/tests/integration_tests/run_integration_test.sh DATSET_ID
```
...
Also run
```commandline
bash nncpunet/tests/integration_tests/run_integration_test_trainingOnly_DDP.sh DATSET_ID
```
...
```commandline
python nncpunet/tests/integration_tests/cleanup_integration_test.py
```
